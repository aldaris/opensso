 ...
 *
 * $Id: Base64.java,v 1.1 2006-10-30 23:16:16 qcheng Exp $
 *
...
public final class  Base64 {
    ...
    protected static boolean isWhiteSpace(char octect) {
        return (octect == 0x20 || octect == 0xd ||
                octect == 0xa || octect == 0x9);
    }
     ...
     *
     * @param binaryData Array containing binaryData
     * @param maxCharsPerLine the max characters per line 
     *        If 0, the encoded result appears on a single line. 
     * @return Encoded Base64 array
     */
