...
public class TableSsoServerPolicyWebGroupTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySsoServerPolicyWebGroupIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerPolicyWebGroupTable:name=com.sun.identity.monitoring.SsoServerPolicyWebGroupEntry" + ",SsoServerRealmIndex=" + _keySsoServerRealmIndex + ",SsoServerPolicyWebGroupIndex=" + _keySsoServerPolicyWebGroupIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    public SnmpIndex buildSnmpIndex(SsoServerPolicyWebGroupEntryMBean entry)
        ...
        oids[0] = val.toOid();
        val = new SnmpInt(entry.getSsoServerPolicyWebGroupIndex());
        oids[1] = val.toOid();
     ...
     * Build index for "SsoServerPolicyWebGroupEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerRealmIndex, Integer aSsoServerPolicyWebGroupIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerRealmIndex).toOid(), oid);
            SnmpInt.appendToOid(new SnmpInt(aSsoServerPolicyWebGroupIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    public Object createSsoServerPolicyWebGroupEntryMBean(SnmpMibSubRequest req,
                ...
                SnmpMibTable meta, Integer  aSsoServerRealmIndex, Integer  aSsoServerPolicyWebGroupIndex)
            throws SnmpStatusException  {
        ...
        entry.SsoServerPolicyWebGroupIndex = aSsoServerPolicyWebGroupIndex;
        return entry;
    }
