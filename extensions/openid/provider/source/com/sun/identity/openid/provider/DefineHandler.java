 ...
 *
 * $Id: DefineHandler.java,v 1.1 2007-04-30 01:28:30 pbryan Exp $
 *
 ...
 * fields to be handled by a managed bean. This allows the page itself to
 * define what fields are to be handled by a backing bean.
 *
 * @author pbryan
 */
public final class DefineHandler extends TagHandler
{
     ...
     *
     * @param config defines the document definition of the new handler.
     */
     ...
     *
     * @param context the current FaceletContext instance for this execution.
     * @param parent the parent UIComponent to operate on.
     */
