<%--
   ...
   $Id: Infocard.jsp,v 1.1 2008-02-28 06:34:46 ppetitsm Exp $
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center" title="">
        ...
        <tr>
            ...
            <td class="LogCntTd" style="background-image: url(<%= ServiceURI %>/images/login-backimage.jpg);
                ...
                <table border="0" background="<%= ServiceURI %>/images/dot.gif" cellpadding="0" cellspacing="0" width="100%" title="">
                    <tr>
                                
                    <td width="260"><img src="<%= ServiceURI %>/images/dot.gif" width="260" height="245" alt="" /></td>
                    
                    <td width="415" bgcolor="#ffffff" valign="top">
                    <img name="Login.productLogo" src="<%= ServiceURI %>/images/PrimaryProductName.png"
                         alt="<auth:resBundle bundleName="amAuthUI" resourceKey="basic_realm"/>" />
                     <img width="71" height="50" align="left" src='<%= ServiceURI %>/images/infocard_71x50.png' onClick="Login.submit()"/>
                     Welcome to the Information Card Login Module!<br>
                     What is <a href="http://en.wikipedia.org/wiki/Information_card">Information Card</a> ?
                     Go to <a href="http://www.bandit-project.org/index.php/Digital_Me#Download">DigitalMe</a>
                      or <a href="http://xmldap.org/">Xmldap.org</a> to install an identity selector plugin for your browser.<br>
