...
:
: $Id: amverifyarchive.bat,v 1.11 2008-07-23 17:14:32 veiming Exp $
:
...
set TOOLS_CLASSPATH=@CONFIG_DIR@;%TOOLS_HOME%/lib/amadm_setup.jar;%TOOLS_HOME%/lib/OpenDS.jar;%TOOLS_HOME%/lib/db.jar;%TOOLS_HOME%/lib/j2ee.jar;%TOOLS_HOME%/lib/ldapjdk.jar;%TOOLS_HOME%/lib/activation.jar;%TOOLS_HOME%/lib/ldapjdk.jar;%TOOLS_HOME%/lib/amserver.jar;%TOOLS_HOME%/lib/opensso-sharedlib.jar;%TOOLS_HOME%/lib/opensso.jar;%TOOLS_HOME/lib/opensso-sharedlib.jar;%TOOLS_HOME%/resources;%TOOLS_HOME%/config
