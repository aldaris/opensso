...
public class TableSsoServerPolicyWebAgentTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySsoServerPolicyWebAgentIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerPolicyWebAgentTable:name=com.sun.identity.monitoring.SsoServerPolicyWebAgentEntry" + ",SsoServerRealmIndex=" + _keySsoServerRealmIndex + ",SsoServerPolicyWebAgentIndex=" + _keySsoServerPolicyWebAgentIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    public SnmpIndex buildSnmpIndex(SsoServerPolicyWebAgentEntryMBean entry)
        ...
        oids[0] = val.toOid();
        val = new SnmpInt(entry.getSsoServerPolicyWebAgentIndex());
        oids[1] = val.toOid();
     ...
     * Build index for "SsoServerPolicyWebAgentEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerRealmIndex, Integer aSsoServerPolicyWebAgentIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerRealmIndex).toOid(), oid);
            SnmpInt.appendToOid(new SnmpInt(aSsoServerPolicyWebAgentIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    public Object createSsoServerPolicyWebAgentEntryMBean(SnmpMibSubRequest req,
                ...
                SnmpMibTable meta, Integer  aSsoServerRealmIndex, Integer  aSsoServerPolicyWebAgentIndex)
            throws SnmpStatusException  {
        ...
        entry.SsoServerPolicyWebAgentIndex = aSsoServerPolicyWebAgentIndex;
        return entry;
    }
