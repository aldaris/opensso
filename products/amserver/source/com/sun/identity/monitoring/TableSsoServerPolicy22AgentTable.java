...
public class TableSsoServerPolicy22AgentTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySsoServerPolicy22AgentIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerPolicy22AgentTable:name=com.sun.identity.monitoring.SsoServerPolicy22AgentEntry" + ",SsoServerRealmIndex=" + _keySsoServerRealmIndex + ",SsoServerPolicy22AgentIndex=" + _keySsoServerPolicy22AgentIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    public SnmpIndex buildSnmpIndex(SsoServerPolicy22AgentEntryMBean entry)
        ...
        oids[0] = val.toOid();
        val = new SnmpInt(entry.getSsoServerPolicy22AgentIndex());
        oids[1] = val.toOid();
     ...
     * Build index for "SsoServerPolicy22AgentEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerRealmIndex, Integer aSsoServerPolicy22AgentIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerRealmIndex).toOid(), oid);
            SnmpInt.appendToOid(new SnmpInt(aSsoServerPolicy22AgentIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    public Object createSsoServerPolicy22AgentEntryMBean(SnmpMibSubRequest req,
                ...
                SnmpMibTable meta, Integer  aSsoServerRealmIndex, Integer  aSsoServerPolicy22AgentIndex)
            throws SnmpStatusException  {
        ...
        entry.SsoServerPolicy22AgentIndex = aSsoServerPolicy22AgentIndex;
        return entry;
    }
