...
# The bulk account federation for SAML v2 in Sun Java System Access Manager or
...
#
# 2. saml2GenerateLDIF.pl - This script is useful if the service provider or the# identity provider is an Access Manager. It helps in generating LDAP Vx
