 ...
 *
 * $Id: Codec.java,v 1.1 2007-04-30 01:28:29 pbryan Exp $
 *
...
public class Codec
{
    ...
    private static final DateFormat DATE = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss'Z'");
     ...
     * @return date value parsed from string, or null if no date could be parsed.
     * @throws DecodeException TODO.
     */
