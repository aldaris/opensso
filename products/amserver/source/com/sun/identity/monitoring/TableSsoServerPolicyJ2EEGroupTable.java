...
public class TableSsoServerPolicyJ2EEGroupTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySsoServerPolicyJ2EEGroupIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerPolicyJ2EEGroupTable:name=com.sun.identity.monitoring.SsoServerPolicyJ2EEGroupEntry" + ",SsoServerRealmIndex=" + _keySsoServerRealmIndex + ",SsoServerPolicyJ2EEGroupIndex=" + _keySsoServerPolicyJ2EEGroupIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    public SnmpIndex buildSnmpIndex(SsoServerPolicyJ2EEGroupEntryMBean entry)
        ...
        oids[0] = val.toOid();
        val = new SnmpInt(entry.getSsoServerPolicyJ2EEGroupIndex());
        oids[1] = val.toOid();
     ...
     * Build index for "SsoServerPolicyJ2EEGroupEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerRealmIndex, Integer aSsoServerPolicyJ2EEGroupIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerRealmIndex).toOid(), oid);
            SnmpInt.appendToOid(new SnmpInt(aSsoServerPolicyJ2EEGroupIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    public Object createSsoServerPolicyJ2EEGroupEntryMBean(SnmpMibSubRequest req,
                ...
                SnmpMibTable meta, Integer  aSsoServerRealmIndex, Integer  aSsoServerPolicyJ2EEGroupIndex)
            throws SnmpStatusException  {
        ...
        entry.SsoServerPolicyJ2EEGroupIndex = aSsoServerPolicyJ2EEGroupIndex;
        return entry;
    }
