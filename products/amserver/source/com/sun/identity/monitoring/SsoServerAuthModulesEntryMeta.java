...
public class SsoServerAuthModulesEntryMeta extends SnmpMibEntry
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 5:
                return new SnmpCounter64(node.getSsoServerAuthModuleFailureCount());

            case 4:
                return new SnmpCounter64(node.getSsoServerAuthModuleSuccessCount());

            case 3:
                return new SnmpString(node.getSsoServerAuthModuleType());

            case 2:
                return new SnmpString(node.getSsoServerAuthModuleName());
