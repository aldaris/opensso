 ...
 *
 * $Id: AMUserPasswordValidationImpl.java,v 1.1 2005-11-01 00:29:28 arvindp Exp $
 *
...
public class AMUserPasswordValidationImpl implements AMConstants {
    ...
    public AMUserPasswordValidationImpl(SSOToken token, String orgDN)
            throws AMException {
        this.orgdn = orgDN;
    ...
    public void validate(Map attributes) throws AMException {
        if (plugin != null) { // Other wise plugin is not valid
            // Validate the userID
            String userNamingAttr = AMNamingAttrManager
                    .getNamingAttr(AMObject.USER);
    ...
    private String getGlobalUserValiadationClass() {
        ...
        if (debug.messageEnabled()) {
            debug.message("AMUserPasswordValidationImplImpl." +
                    ...
                    USERID_PASSWORD_VALIDATION_CLASS + ") not found. " +
        ...
        try {
            ...
            if (debug.warningEnabled()) {
                debug.warning("AMUserPasswordValidationImplImpl." +
                        ...
                        "UserID & Password validation plugin information",e);
            }
        }
        return null;
    }
