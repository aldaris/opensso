 ...
 *
 * $Id: SearchIdentitiesTest.java,v 1.1 2007-09-04 21:43:27 bt199000 Exp $
 *
...
/**
 * <code>SearchIdentitiesTest</code> executes test cases to search for 
 * identities with identity type user, role, filtered role, group, and agent.
 * This class reads test data in searchIdentitiesTest.properties file, creates 
 * one or more identities in the setup method, executes the tests to search for 
 * identities with identity name or the pattern, verifies the status, and 
 * removes all identities previously created. 
 */
public class SearchIdentitiesTest extends IDMCommon {
    ...
    /**
     * Creates a new instance of SearchIdentitiesTest
     */
    public SearchIdentitiesTest() {
        super("SearchIdentitiesTest");
    }
    ...
    throws Exception {
        ...
        try {
            ...
            testName=IDMConstants.IDM_TESTCASES_SEARCH_NAME;
    ...
    /**
     * This test case searches one or multiple identities by identity name or
     * pattern.
     */
    @Test(groups={"ds_ds","ds_ds_sec","ff_ds","ff_ds_sec"})
    public void testSearchIdentities()
    throws Exception {
        entering("testSearchIdentities", null);
        try {
            assert(idObj.search());
        } catch (Exception e) {
            log(Level.SEVERE, "testSearchIdentities", e.getMessage());
            e.printStackTrace();
            throw e;
        }
    ...
    /**
     * This method provides the test clean tup.
     */
