...
public class TableSsoServerSAML2IDPTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySsoServerSAML2IDPIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerSAML2IDPTable:name=com.sun.identity.monitoring.SsoServerSAML2IDPEntry" + ",SsoServerRealmIndex=" + _keySsoServerRealmIndex + ",SsoServerSAML2IDPIndex=" + _keySsoServerSAML2IDPIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    public SnmpIndex buildSnmpIndex(SsoServerSAML2IDPEntryMBean entry)
        ...
        oids[0] = val.toOid();
        val = new SnmpInt(entry.getSsoServerSAML2IDPIndex());
        oids[1] = val.toOid();
     ...
     * Build index for "SsoServerSAML2IDPEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerRealmIndex, Integer aSsoServerSAML2IDPIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerRealmIndex).toOid(), oid);
            SnmpInt.appendToOid(new SnmpInt(aSsoServerSAML2IDPIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    public Object createSsoServerSAML2IDPEntryMBean(SnmpMibSubRequest req,
                ...
                SnmpMibTable meta, Integer  aSsoServerRealmIndex, Integer  aSsoServerSAML2IDPIndex)
            throws SnmpStatusException  {
        ...
        entry.SsoServerSAML2IDPIndex = aSsoServerSAML2IDPIndex;
        return entry;
    }
