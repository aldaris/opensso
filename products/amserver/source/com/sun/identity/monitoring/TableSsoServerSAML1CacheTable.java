...
public class TableSsoServerSAML1CacheTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySsoServerSAML1CacheIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerSAML1CacheTable:name=com.sun.identity.monitoring.SsoServerSAML1CacheEntry" + ",SsoServerSAML1CacheIndex=" + _keySsoServerSAML1CacheIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    public SnmpIndex buildSnmpIndex(SsoServerSAML1CacheEntryMBean entry)
        ...
        SnmpValue val = null;
        val = new SnmpInt(entry.getSsoServerSAML1CacheIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "SsoServerSAML1CacheEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerSAML1CacheIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerSAML1CacheIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    public Object createSsoServerSAML1CacheEntryMBean(SnmpMibSubRequest req,
                ...
                SnmpMibTable meta, Integer  aSsoServerSAML1CacheIndex)
            throws SnmpStatusException  {
        ...
        entry.SsoServerSAML1CacheIndex = aSsoServerSAML1CacheIndex;
        return entry;
    }
