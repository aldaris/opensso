...
# The bulk account federation for SAML v2 in Sun OpenSSO Enterprise or
...
#
# 2. saml2GenerateLDIF.pl - This script is useful if the service provider or the# identity provider is an OpenSSO Enterprise. It helps in generating LDAP Vx
