<%--
   ...
   $Id: SAMLv2IDP.jsp,v 1.3 2008-06-25 05:50:23 qcheng Exp $
   
--%>

<%@ page info="SAMLv2IDP" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.federation.SAMLv2IDPViewBean"
...
<cc:form name="SAMLv2IDP" method="post" defaultCommandChild="/button1">
