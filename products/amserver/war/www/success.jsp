...
<%  
    ...
    if (deployURI != null) {
        int idx = deployURI.indexOf("/success.jsp");
        if (idx > 0) {
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        <div style="color: #50697d; font-size:16px">
                            Configuration is complete. What would you like
                            to do next?
                                          
                            <ul>
                                <li><a href="http://docs.sun.com/app/docs/coll/1292.1?l=en&q=Access+Manager+7">Read the product documentation</a>
                            </ul>
                            <ul>
                                <li><a href="<%= deployURI %>/UI/Login">Login to the administration console</a>
                            </ul>
                        </div>   
                    </td>
                </tr>
