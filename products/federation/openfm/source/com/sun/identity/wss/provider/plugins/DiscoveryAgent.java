 ...
 *
 * $Id: DiscoveryAgent.java,v 1.1 2007-03-23 00:01:54 mallas Exp $
 *
...
public class DiscoveryAgent extends DiscoveryConfig {
        ...
        try {
            ...
            if (profilePresent) {
                ...
                AMIdentity id = new AMIdentity(token,
                    getEntry(name, type), IdType.AGENT, "/", null);
    ...
    private String getEntry(String name, String type) {
        return name + type;
    }
