 ...
 *
 * $Id: IdRepoListener.java,v 1.1 2005-11-01 00:29:25 arvindp Exp $
 *
...
public final class IdRepoListener {
    ...
    public void allObjectsChanged() {
        ...
        amdm.clearCache(AMCacheManager.idrepoCache);
    ...
    public void objectChanged(String name, int type, Map cMap) {
        ...
        for (int i = 0; i < changed.length; i++) {
            amdm
                    .dirtyCache(AMCacheManager.idrepoCache, changed[i],
    ...
    public void setServiceAttributes(String sName, Map attrs)
        ...
        if (realm == null || pluginName == null) {
            AMIdentityRepository.debug.error(
                    "IdRepoListener.setServiveAttribute: realm or plugin " +
                    "name is null");
