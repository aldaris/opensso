...
#define AM_COMMON_AGENTS_CONFIG_POLLING_PROPERTY AM_COMMON_PROPERTY_PREFIX "agents.config.polling.interval"
#define AM_COMMON_AGENTS_CONFIG_CLEANUP_PROPERTY AM_COMMON_PROPERTY_PREFIX "agents.config.cleanup.interval"
