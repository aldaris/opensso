...
public class FMSubjectMapperTest extends UnitTestBase {
    ...
    public FMSubjectMapperTest() {
        super("OpenFed-xacml2-FMSubjectMapperTest");
    }
    ...
    @Test(groups={"xacml2"})
    public void testMapToNativeSubject() throws XACML2Exception, URISyntaxException {
	FMSubjectMapper subjectMapper = new FMSubjectMapper();
    ...
    /*
    public void testInitizlise() throws XACML2Exception {
    }
    */
