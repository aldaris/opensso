 ...
 *
 * $Id: AMURLEncDec.java,v 1.1 2006-10-30 23:16:16 qcheng Exp $
 *
...
/**
 * This class is used as url encode and decode utility.
 */
public class AMURLEncDec {
     ...
     * UTF-8 should be used to ensure compatibilities.
     *
    ...
    public static String encode(String s) {
        ...
        try {
            ...
            CookieUtils.debug.error("URLEncDec.encode:" + e.getMessage()); 
        }
        return ret;
    }
    /**
     ...
     */
     public static String decode(String s) {
        ...
        try {
            ...
            CookieUtils.debug.error("AMURLEncDec.decode:" + e.getMessage()); 
        }
        return ret;
    }
    /**
    ...
    /* Construct LDAP url string by converting non-ascii
     * characters to application/x-www-form-urlencoded
     * format using UTF8. See RFC 2255 and RFC 1738 for
     * valid LDAP url format.
     */
    public static String encodeLDAPUrl(String s) {
        ...
        try {
            ...
            CookieUtils.debug.error("AMURLEncDec.decode:" + 
                                     uee.getMessage());
