 ...
 *
 * $Id: Functions.java,v 1.1 2007-04-30 01:28:30 pbryan Exp $
 *
...
public class Functions
{
     ...
     * TODO: Description.
     *
     * @param xss the text that should be protected from cross-site scripting.
     * @return TODO.
     */
    ...
    public static String strong(String text) {
        ...
        return buf.append("<strong>").append(text).append("</strong>").toString();
    }
}
