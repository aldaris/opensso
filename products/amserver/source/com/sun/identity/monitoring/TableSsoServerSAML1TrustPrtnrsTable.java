...
public class TableSsoServerSAML1TrustPrtnrsTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySsoServerSAML1TrustPrtnrIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerSAML1TrustPrtnrsTable:name=com.sun.identity.monitoring.SsoServerSAML1TrustPrtnrsEntry" + ",SsoServerSAML1TrustPrtnrIndex=" + _keySsoServerSAML1TrustPrtnrIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    public SnmpIndex buildSnmpIndex(SsoServerSAML1TrustPrtnrsEntryMBean entry)
        ...
        SnmpValue val = null;
        val = new SnmpInt(entry.getSsoServerSAML1TrustPrtnrIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "SsoServerSAML1TrustPrtnrsEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerSAML1TrustPrtnrIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerSAML1TrustPrtnrIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    public Object createSsoServerSAML1TrustPrtnrsEntryMBean(SnmpMibSubRequest req,
                ...
                SnmpMibTable meta, Integer  aSsoServerSAML1TrustPrtnrIndex)
            throws SnmpStatusException  {
        ...
        entry.SsoServerSAML1TrustPrtnrIndex = aSsoServerSAML1TrustPrtnrIndex;
        return entry;
    }
