<%--
   ...
   $Id: infocardInvalidCert.jsp,v 1.1 2009-07-08 08:59:27 ppetitsm Exp $
...
<%@page info="Invalid Information Card Certificate" language="java"%>
          ...
          <tr>
            ...
            border="0" />                                          
              <table border="0" cellspacing="0" cellpadding="0">
                ...
                height="21" width="21" />
                <auth:resBundle bundleName="amAuthInfocard" resourceKey="invalidCert" />
                </div>
