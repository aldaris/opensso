...
public class TableSsoServerLoggingHdlrTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySsoServerLoggingHdlrIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerLoggingHdlrTable:name=com.sun.identity.monitoring.SsoServerLoggingHdlrEntry" + ",SsoServerLoggingHdlrIndex=" + _keySsoServerLoggingHdlrIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    public SnmpIndex buildSnmpIndex(SsoServerLoggingHdlrEntryMBean entry)
        ...
        SnmpValue val = null;
        val = new SnmpInt(entry.getSsoServerLoggingHdlrIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "SsoServerLoggingHdlrEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerLoggingHdlrIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerLoggingHdlrIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    public Object createSsoServerLoggingHdlrEntryMBean(SnmpMibSubRequest req,
                ...
                SnmpMibTable meta, Integer  aSsoServerLoggingHdlrIndex)
            throws SnmpStatusException  {
        ...
        entry.SsoServerLoggingHdlrIndex = aSsoServerLoggingHdlrIndex;
        return entry;
    }
