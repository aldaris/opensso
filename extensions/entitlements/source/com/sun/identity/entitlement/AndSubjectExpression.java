 ...
 *
 * $Id: AndSubjectExpression.java,v 1.1 2009-01-12 22:11:22 dillidorai Exp $
 */
...
/**
 * Class to combine entitlement subjects using logical AND during
 * evaluation. 
 */
public class AndSubjectExpression extends SubjectExpression {

    /**
     * Constructs subject expression
     */
    public AndSubjectExpression() {
    }
     ...
     * expression
     */
    public AndSubjectExpression(List<SubjectFilter> sf) {
    }
