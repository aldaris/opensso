...
public class StatusMessageImpl implements StatusMessage {
     ...
     */
    public StatusMessageImpl() throws XACML2Exception {
    }
     ...
     */
    public StatusMessageImpl(String xml) throws XACML2Exception {
     ...
     */
    public StatusMessageImpl(Element element) throws XACML2Exception {
    ...
    public void setValue(String value) throws XACML2Exception {
        ...
        if (!XACML2SDKUtils.isValidStatusMessage(value)) {
            throw new XACML2Exception(
    ...
    */
    ...
    private void processElement(Element element) throws XACML2Exception {
        ...
        if (!elemName.equals(XACML2Constants.STATUS_MESSAGE_ELEMENT)) {
            XACML2SDKUtils.debug.error(
        ...
        if (!XACML2SDKUtils.isValidStatusMessage(elementValue.trim())) {
            throw new XACML2Exception(
                    XACML2SDKUtils.bundle.getString("invalid_value")); //i18n
        } else {
