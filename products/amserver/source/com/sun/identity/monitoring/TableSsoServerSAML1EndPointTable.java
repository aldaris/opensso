...
public class TableSsoServerSAML1EndPointTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySsoServerSAML1EndPointIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerSAML1EndPointTable:name=com.sun.identity.monitoring.SsoServerSAML1EndPointEntry" + ",SsoServerSAML1EndPointIndex=" + _keySsoServerSAML1EndPointIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    public SnmpIndex buildSnmpIndex(SsoServerSAML1EndPointEntryMBean entry)
        ...
        SnmpValue val = null;
        val = new SnmpInt(entry.getSsoServerSAML1EndPointIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "SsoServerSAML1EndPointEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerSAML1EndPointIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerSAML1EndPointIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    public Object createSsoServerSAML1EndPointEntryMBean(SnmpMibSubRequest req,
                ...
                SnmpMibTable meta, Integer  aSsoServerSAML1EndPointIndex)
            throws SnmpStatusException  {
        ...
        entry.SsoServerSAML1EndPointIndex = aSsoServerSAML1EndPointIndex;
        return entry;
    }
