...
public class TableSsoServerAuthModulesTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySsoServerAuthModuleIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerAuthModulesTable:name=com.sun.identity.monitoring.SsoServerAuthModulesEntry" + ",SsoServerRealmIndex=" + _keySsoServerRealmIndex + ",SsoServerAuthModuleIndex=" + _keySsoServerAuthModuleIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    public SnmpIndex buildSnmpIndex(SsoServerAuthModulesEntryMBean entry)
        ...
        oids[0] = val.toOid();
        val = new SnmpInt(entry.getSsoServerAuthModuleIndex());
        oids[1] = val.toOid();
     ...
     * Build index for "SsoServerAuthModulesEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerRealmIndex, Integer aSsoServerAuthModuleIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerRealmIndex).toOid(), oid);
            SnmpInt.appendToOid(new SnmpInt(aSsoServerAuthModuleIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    public Object createSsoServerAuthModulesEntryMBean(SnmpMibSubRequest req,
                ...
                SnmpMibTable meta, Integer  aSsoServerRealmIndex, Integer  aSsoServerAuthModuleIndex)
            throws SnmpStatusException  {
        ...
        entry.SsoServerAuthModuleIndex = aSsoServerAuthModuleIndex;
        return entry;
    }
