...
#define AM_POLICY_SLBCOOKIE_PROPERTY      AM_POLICY_PROPERTY_PREFIX "lb.cookie.name"
#define AM_POLICY_SLBCOOKIE_PROPERTY_OLD      AM_POLICY_PROPERTY_PREFIX "ias_SLB_cookie_name"
