...
<table style="width: 800px; text-align: left;" border="0" cellpadding="2" cellspacing="2">
  <tbody>
    <tr>
      ...
      <a href="http://wwws.sun.com/software/products/access_mgr/index.html" id="homelink">Sun Java System Access Manager<br></a></td>
    ...
    <tr>
      ...
      <td style="vertical-align: top;">
      <hr class="menutop">
      <div style="text-align: right;">Use Restricted to Terms and Conditions of Applicable License Agreement</div>
      </td>
      <td style="vertical-align: top; width: 50px;">&nbsp;<br>
      </td>
    </tr>
