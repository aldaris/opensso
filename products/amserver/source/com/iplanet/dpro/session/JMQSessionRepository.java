 ...
 *
 * $Id: JMQSessionRepository.java,v 1.1 2008-04-21 19:08:43 weisun2 Exp $
 *
...
public class JMQSessionRepository extends GeneralTaskRunnable implements
    ...
    public FAMRecordJMQPersister pSession = null;
   ...
   public JMQSessionRepository() throws Exception {
    ...
    private void initPersistSession() {
        try {
            //TODO: use interface revoke 
            pSession = new FAMRecordJMQPersister(serverId,
                    SessionService.getJdbcURL(),
                    SessionService.getSessionStoreUserName(),
                    SessionService.getSessionStorePassword(), 
                    SessionService.getConnectionMaxWaitTime(),
