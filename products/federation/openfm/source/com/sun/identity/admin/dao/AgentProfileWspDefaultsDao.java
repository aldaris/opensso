 ...
 * 
 * $Id: AgentProfileWspDefaultsDao.java,v 1.1 2009-10-08 16:16:20 ggennaro Exp $
 */
...
public class AgentProfileWspDefaultsDao
        extends AgentProfileDefaultsDao
{
    private static final String typeName = "WSPAgent";

    protected static String getDefault(String attributeName) {
        try {
            return getDefault(typeName, attributeName);
        } catch (SMSException ex) {
            Logger.getLogger(AgentProfileWspDefaultsDao.class.getName()).log(Level.SEVERE, null, ex);
            return null;
