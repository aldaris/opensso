<%--
   ...
   $Id: ConditionNoneEdit.jsp,v 1.1 2006-05-04 06:56:30 veiming Exp $
...
<%@ page info="ConditionNoneEdit" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.policy.ConditionNoneEditViewBean"
...
<cc:form name="ConditionNoneEdit" method="post" defaultCommandChild="/button1">
