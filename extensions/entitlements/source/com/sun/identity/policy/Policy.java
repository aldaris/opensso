 ...
 *
 * $Id: Policy.java,v 1.1 2009-02-18 22:38:12 veiming Exp $
 *
 */
...
//    public String getServiceTypeName() {
 ...
 //       return null;
  //  }
    ...
    public boolean doesSubjectMatch(SSOToken token)
        throws SSOException, PolicyException {
        return (token == null) ? true : users.isMember(token);
    }

    public boolean doConditionsMatch(SSOToken token, Map envParameters)
        throws PolicyException, SSOException {
        ConditionDecision conditionDecision = conditions.getConditionDecision(
            token, envParameters);
        return conditionDecision.isAllowed();
    } 
}
