<%--
   ...
   $Id: ConditionNoneAdd.jsp,v 1.1 2006-05-04 06:56:29 veiming Exp $
...
<%@ page info="ConditionNoneAdd" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.policy.ConditionNoneAddViewBean"
...
<cc:form name="ConditionNoneAdd" method="post" defaultCommandChild="/button1">
