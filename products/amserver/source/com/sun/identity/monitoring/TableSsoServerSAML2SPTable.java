...
public class TableSsoServerSAML2SPTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySsoServerSAML2SPIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerSAML2SPTable:name=com.sun.identity.monitoring.SsoServerSAML2SPEntry" + ",SsoServerRealmIndex=" + _keySsoServerRealmIndex + ",SsoServerSAML2SPIndex=" + _keySsoServerSAML2SPIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    public SnmpIndex buildSnmpIndex(SsoServerSAML2SPEntryMBean entry)
        ...
        oids[0] = val.toOid();
        val = new SnmpInt(entry.getSsoServerSAML2SPIndex());
        oids[1] = val.toOid();
     ...
     * Build index for "SsoServerSAML2SPEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerRealmIndex, Integer aSsoServerSAML2SPIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerRealmIndex).toOid(), oid);
            SnmpInt.appendToOid(new SnmpInt(aSsoServerSAML2SPIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    public Object createSsoServerSAML2SPEntryMBean(SnmpMibSubRequest req,
                ...
                SnmpMibTable meta, Integer  aSsoServerRealmIndex, Integer  aSsoServerSAML2SPIndex)
            throws SnmpStatusException  {
        ...
        entry.SsoServerSAML2SPIndex = aSsoServerSAML2SPIndex;
        return entry;
    }
