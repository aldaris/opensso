...
class CacheBlock {
    ...
    protected CacheBlock(String entryDN, boolean validEntry) {
        if (validEntry) {
    ...
    protected CacheBlock(String entryDN, String orgDN, boolean validEntry) {
        this(entryDN, validEntry);
        this.organizationDN = orgDN;
    }

    protected synchronized void setExists(boolean exists) {
        if (exists) {
            cacheEntries = new AMHashMap();
            stringAttributes = new AMHashMap(false);
            byteAttributes = new AMHashMap(true);
    ...
    protected synchronized void setObjectType(int type) {
        objectType = type;
    }

    protected synchronized void setOrganizationDN(String orgDN) {
    ...
    protected synchronized boolean hasCompleteSet(String principalDN) {
    ...
    protected synchronized void putAttributes(String principalDN,
            Map attributes, Set inAccessibleAttrNames, boolean isCompleteSet,
            boolean byteValues) {
        CacheEntry ce = (CacheEntry) cacheEntries.get(principalDN);
        if (ce == null) {
            ce = new CacheEntry();
    ...
    protected synchronized void removeAttributes(String principalDN) {
    ...
    protected synchronized void removeAttributes(Set attrNames) {
    ...
    protected synchronized void replaceAttributes(String principalDN,
    ...
    protected synchronized void clear() {
        ...
        objectType = AMObject.UNDETERMINED_OBJECT_TYPE;
    ...
    public String toString() {
        ...
        sb.append("\nString Attributes: ");
        sb.append(AMCommonUtils.mapSetToString(stringAttributes));
        sb.append("\nByte Attributes: ");
        sb.append(AMCommonUtils.mapSetToString(byteAttributes));
