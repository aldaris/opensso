...
public class TableSsoServerSitesTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySsoServerSiteId = oid.toInteger().toString();
            return new ObjectName("TableSsoServerSitesTable:name=com.sun.identity.monitoring.SsoServerSitesEntry" + ",SsoServerSiteId=" + _keySsoServerSiteId);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    public SnmpIndex buildSnmpIndex(SsoServerSitesEntryMBean entry)
        ...
        SnmpValue val = null;
        val = new SnmpInt(entry.getSsoServerSiteId());
        oids[0] = val.toOid();
     ...
     * Build index for "SsoServerSitesEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerSiteId)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerSiteId).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    public Object createSsoServerSitesEntryMBean(SnmpMibSubRequest req,
                ...
                SnmpMibTable meta, Integer  aSsoServerSiteId)
            throws SnmpStatusException  {
        ...
        entry.SsoServerSiteId = aSsoServerSiteId;
        return entry;
    }
