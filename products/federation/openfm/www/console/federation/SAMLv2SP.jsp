<%--
   ...
   $Id: SAMLv2SP.jsp,v 1.2 2007-11-09 18:40:14 babysunil Exp $
   
   Copyright 2007 Sun Microsystems Inc. All Rights Reserved
--%>

<%@ page info="SAMLv2SP" language="java" %>
<%@taglib uri="/WEB-INF/jato.tld" prefix="jato" %>
<%@taglib uri="/WEB-INF/cc.tld" prefix="cc" %>
<jato:useViewBean
    className="com.sun.identity.console.federation.SAMLv2SPViewBean"
...
<cc:form name="SAMLv2SP" method="post" defaultCommandChild="/button1">
