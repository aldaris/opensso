...
function isValidIssueId(id, writemsg)
{
    uhttp_request = get_request_handle()
    try {
        uhttp_request.open('GET', issueurl, false);
        uhttp_request.send(null);
        var result = uhttp_request.responseText;
