...
public class AmFilterRequestContext implements IUtilConstants {
    ...
    /**
     * Returns the value of the GOTO parameter to be used for post 
     * authentication redirect by the authentication service. If the request 
     * is a form login request, the return value will point to the application 
     * context root. Otherwise the return value will be a complete URL of the 
     * requested resource.
     *
    ...
    public String getAuthRedirectURL(AmWebPolicyResult amWebPolicyResult,
        ...
        if((amWebPolicyResult != null)
        && amWebPolicyResult.hasNameValuePairs()) {
     ...
     * @return an <code>AmFilter</code> to redirect the user to the specified
     * URL.
     */
    ...
    /**
     * Returns a result for serving some specified data for handling the
     * request.
     *
     ...
     * continue result for filter processing.
     * If a <code>IHttpServletRequestHelper</code>
     * has been set for this request, it will be automatically added to
     * the result.
     *
     ...
     * specific to SSO validation has not been invoked yet, the user is
     * considered unauthenticated and therefore this method will return a
     * <code>null</code> value.
     *
     * @return the DN of the currently authenticated user or <code>null</code>
     * if the current request has not been subjected to SSO validation yet.
     */
    ...
    /**
     * Returns the user name for the currently authenticated user. If the
     * property use dn is set to true, the name will be the user DN. If set to
     * false, this value will be the UID of the user. This method will return
     * <code>null</code>  if the current user has not been authenticated yet.
     *
     * @return the user name of the currently authenticated user, or
     ...
     * @return the instnace of <code>IHttpServletRequestHelper</code> if
     * available or <code>null</code> if no such instnace is available.
     */
     ...
     * <code>IHttpServletRequestHelper</code> available for wrapping the
     * reqeust.
     *
     ...
     * handler was not invoked prior to this method call, or if the SSO
     * validation failed for the current user, the return from this method will
     * be <code>null</code>.
     * @return the <code>SSOValidationResult</code> object for the current
     * request if available, <code>null</code> otherwise.
     */
     ...
     * @param httpServletRequestHelper the <code>IHttpServletRequestHelper
     * </code> instance that will be used for wrapping this request.
     */
    ...
    /**
     * Sets a <code>Map</code> that contains the response attributes as 
     * evaluated by the remote policy.
     ...
     */
    public void setSSOValidationResult(
    ...
    public boolean isAuthenticated() {
        ...
        if (_ssoValidationResult != null
                && _ssoValidationResult.isValid()) {
            result = true;
        }
    ...
    private void setLoginURLFailoverHelper(
            IURLFailoverHelper loginURLFailoverHelper) {
     ...
     * specifies the protocol, host and port information and does nto contain
     * any URI or query strings.
     *
     */
