...
public class SsoServerPolicySvcMeta extends SnmpMibGroup
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 3:
                return new SnmpCounter64(node.getSsoServerPolicyEvalsOut());

            case 2:
                return new SnmpCounter64(node.getSsoServerPolicyEvalsIn());

            case 1:
                return new SnmpString(node.getSsoServerPolicyStatus());
