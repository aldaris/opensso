...
public class SubjectImpl implements Subject {
    ...
    */
     ...
     */
    public SubjectImpl(String xml) throws XACML2Exception {
     ...
     */
    public SubjectImpl(Element element) throws XACML2Exception {
             ...
             try {
               ...
               values.add(subjectCategory.toString());
                 subjectCategoryAttribute = 
                     XACML2SDKUtils.createAttribute(values, new URI(
