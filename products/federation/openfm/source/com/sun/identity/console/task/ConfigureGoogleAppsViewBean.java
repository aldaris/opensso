 ...
 *
 * $Id: ConfigureGoogleAppsViewBean.java,v 1.1 2009-02-24 18:43:57 babysunil Exp $
 *
 */
    ...
    extends AMPrimaryMastHeadViewBean
{
    ...
    public void forwardTo(RequestContext rc) {
        ...
        if (hasIdp) {
            ...
            ConfigureGoogleAppsWarningViewBean vb = (ConfigureGoogleAppsWarningViewBean)
                getViewBean(ConfigureGoogleAppsWarningViewBean.class);
            vb.forwardTo(rc);
        }
    }
