...
public class TableSsoServerSiteMapTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySsoServerSiteMapIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerSiteMapTable:name=com.sun.identity.monitoring.SsoServerSiteMapEntry" + ",SsoServerSiteMapIndex=" + _keySsoServerSiteMapIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    public SnmpIndex buildSnmpIndex(SsoServerSiteMapEntryMBean entry)
        ...
        SnmpValue val = null;
        val = new SnmpInt(entry.getSsoServerSiteMapIndex());
        oids[0] = val.toOid();
     ...
     * Build index for "SsoServerSiteMapEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerSiteMapIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerSiteMapIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    public Object createSsoServerSiteMapEntryMBean(SnmpMibSubRequest req,
                ...
                SnmpMibTable meta, Integer  aSsoServerSiteMapIndex)
            throws SnmpStatusException  {
        ...
        entry.SsoServerSiteMapIndex = aSsoServerSiteMapIndex;
        return entry;
    }
