...
public class SsoServerSvcMgmtSvcMeta extends SnmpMibGroup
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 6:
                return new SnmpString(node.getSsoServerSvcMgmtRepositorySSL());

            case 5:
                return new SnmpString(node.getSsoServerSvcMgmtRepositoryOrgDN());

            case 4:
                return new SnmpString(node.getSsoServerSvcMgmtRepositoryBindDN());

            case 3:
                return new SnmpString(node.getSsoServerSvcMgmtRepositoryHostPort());

            case 2:
                return new SnmpString(node.getSsoServerSvcMgmtRepositoryType());

            case 1:
                return new SnmpString(node.getSsoServerSvcMgmtStatus());
