 ...
 *
 * $Id: ResourceTest.java,v 1.1 2007-03-15 06:21:03 bhavnab Exp $
 *
 ...
 * <code>com.sun.identity.xacml2.context.Resource</code> class.
 */
...
public class ResourceTest extends UnitTestBase {
     ...
     * @throws XACML2Exception if there is creating the <code>Resource</code>
     ...
     */
    @Test(groups = {"xacml2"})
    public void testResource() throws XACML2Exception, URISyntaxException {
