...
public class TableSsoServerServerTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySsoServerServerId = oid.toInteger().toString();
            return new ObjectName("TableSsoServerServerTable:name=com.sun.identity.monitoring.SsoServerServerEntry" + ",SsoServerServerId=" + _keySsoServerServerId);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    public SnmpIndex buildSnmpIndex(SsoServerServerEntryMBean entry)
        ...
        SnmpValue val = null;
        val = new SnmpInt(entry.getSsoServerServerId());
        oids[0] = val.toOid();
     ...
     * Build index for "SsoServerServerEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerServerId)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerServerId).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    public Object createSsoServerServerEntryMBean(SnmpMibSubRequest req,
                ...
                SnmpMibTable meta, Integer  aSsoServerServerId)
            throws SnmpStatusException  {
        ...
        entry.SsoServerServerId = aSsoServerServerId;
        return entry;
    }
