...
public class TableSsoServerPolicyJ2EEAgentTable extends SnmpTableSupport implements Serializable {
    ...
    public ObjectName buildNameFromIndex(SnmpIndex index)
        ...
        try  {
            ...
            String _keySsoServerPolicyJ2EEAgentIndex = oid.toInteger().toString();
            return new ObjectName("TableSsoServerPolicyJ2EEAgentTable:name=com.sun.identity.monitoring.SsoServerPolicyJ2EEAgentEntry" + ",SsoServerRealmIndex=" + _keySsoServerRealmIndex + ",SsoServerPolicyJ2EEAgentIndex=" + _keySsoServerPolicyJ2EEAgentIndex);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.snmpRspWrongValue);
        } catch(Exception e) {
            throw new SnmpStatusException(e.getMessage());
    ...
    public SnmpIndex buildSnmpIndex(SsoServerPolicyJ2EEAgentEntryMBean entry)
        ...
        oids[0] = val.toOid();
        val = new SnmpInt(entry.getSsoServerPolicyJ2EEAgentIndex());
        oids[1] = val.toOid();
     ...
     * Build index for "SsoServerPolicyJ2EEAgentEntry".
     */
    public SnmpOid buildOidFromIndexVal(Integer aSsoServerRealmIndex, Integer aSsoServerPolicyJ2EEAgentIndex)
        throws SnmpStatusException  {
        SnmpOid oid = new SnmpOid();
        try {
            SnmpInt.appendToOid(new SnmpInt(aSsoServerRealmIndex).toOid(), oid);
            SnmpInt.appendToOid(new SnmpInt(aSsoServerPolicyJ2EEAgentIndex).toOid(), oid);
        } catch(ArrayIndexOutOfBoundsException e) {
            throw new SnmpStatusException(SnmpStatusException.noSuchInstance);
        }
        return oid;
    ...
    public Object createSsoServerPolicyJ2EEAgentEntryMBean(SnmpMibSubRequest req,
                ...
                SnmpMibTable meta, Integer  aSsoServerRealmIndex, Integer  aSsoServerPolicyJ2EEAgentIndex)
            throws SnmpStatusException  {
        ...
        entry.SsoServerPolicyJ2EEAgentIndex = aSsoServerPolicyJ2EEAgentIndex;
        return entry;
    }
