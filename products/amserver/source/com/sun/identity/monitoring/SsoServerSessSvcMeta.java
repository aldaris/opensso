...
public class SsoServerSessSvcMeta extends SnmpMibGroup
    ...
    public SnmpValue get(long var, Object data)
        ...
        switch((int)var) {
            case 6:
                return new SnmpInt(node.getSsoServerSessAveSessSize());

            case 5:
                return new SnmpCounter64(node.getSsoServerSessNotifListnrCount());

            case 4:
                return new SnmpCounter64(node.getSsoServerSessNotifCount());

            case 3:
                return new SnmpCounter64(node.getSsoServerSessValidationsCount());

            case 2:
                return new SnmpCounter64(node.getSsoServerSessCreatedCount());

            case 1:
                return new SnmpCounter64(node.getSsoServerSessActiveCount());

            case 7:
                return new SnmpString(node.getSsoServerSessSFOBroker());
