 ...
 *
 * $Id: ConnectionFactoryProvider.java,v 1.1 2005-11-01 00:29:51 arvindp Exp $
 *
...
public interface ConnectionFactoryProvider {
     ...
     * @param connectionAttemptOrder
     *            the scheme to be used for attempting connections
     ...
     */
    public TopicConnectionFactory newTopicConnectionFactory(
            String brokerAddressList, String connectionAttemptOrder,
            boolean reconnectEnabled, boolean flowLimitEnabled,
            String defaultUsername, String defaultPassword) throws Exception;
}
