 ...
 *
 * $Id: ActionImpl.java,v 1.1 2007-04-03 16:59:07 pawand Exp $
 *
...
public class ActionImpl implements Action {
    ...
    public ActionImpl(String xml) throws XACML2Exception {
     ...
     */
    public ActionImpl(Element element) throws XACML2Exception {
    ...
    private void processElement(Element element) throws XACML2Exception {
        ...
        if (!elemName.equals(XACML2Constants.ACTION)) {
            XACML2SDKUtils.debug.error(
            ...
            for (int nextElem = 0; nextElem < numOfNodes; nextElem++) {
                ...
                if (child.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    if (attrChildName.equals(XACML2Constants.ATTRIBUTE)) {
                        ...
                        XACML2SDKUtils.debug.error("ActionImpl."
    ...
    public String toXMLString(boolean includeNSPrefix, boolean declareNS) 
        ...
        sb.append("<").append(nsDeclaration).append(XACML2Constants.ACTION).
